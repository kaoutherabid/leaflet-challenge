...
var myMap = L.map("map", {
    ...
    zoom: 5,
    layers: [defaultMap, grayscale, waterColor, topoMap, outdoors, satellite],
});
...
d3.json(
    ...
    function radiusSize(mag){
      if (mag == 0)
          ...
          return mag * 5; // makes sure that the circle is pronouced in the map
    }
    ...
    L.geoJson(earthquakeData, {
      ...
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
          `Magnitude: <b>${feature.properties.mag}</b><br>Depth: 
                      <b>${feature.geometry.coordinates[2]}</b><br>Location: 
                      <b>${feature.properties.place}</b>`
        );
      },
    }).addTo(earthquakes);
  });
